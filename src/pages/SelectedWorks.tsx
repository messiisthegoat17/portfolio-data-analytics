...
const projects = [
  {
    id: "001",
    title: "CLV Predictor: Customer Lifetime Value Intelligence",
    stack: "React / TypeScript / Python / Machine Learning / Vercel",
    description: "Final year project — an ML-powered platform that predicts Customer Lifetime Value using behavioral and transactional data, enabling businesses to identify high-value customers, optimize retention strategies, and maximize revenue through data-driven segmentation.",
    links: { live: "https://clvpredictionproject.vercel.app", code: "https://github.com/messiisthegoat17/CLV-FINAL-year-project-" },
    image: "./p5.png",
    cta: "Live Project"
  },
  {
    id: "002",
    title: "AI-Driven Healthcare: Non-Medical Device Platform",
    stack: "Python / Django / HTML / CSS / AI / ML",
    description: "An AI-powered healthcare web platform enabling patients to consult doctors, analyze health reports, and receive AI-driven diagnostics — all without reliance on physical medical devices. Features account management, doctor listings, and intelligent health report analysis.",
    links: { live: "#", code: "https://github.com/pratikkokare38-tech/AI-driven-healthcare-non-medical-device" },
    image: "./p2.png",
    cta: "View on Github"
  },
  {
